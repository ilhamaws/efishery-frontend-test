...
export const FormModal = (props) => {
	...
	return (
		<div>
            <button onClick={toggle} className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-200 transition duration-150 ease-in-out hover:bg-slate-200 bg-slate-100 rounded text-teal-600 px-8 py-2 text-sm">
                Tambah data
            </button>
